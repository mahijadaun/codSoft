...
button=Button(frame,text="Add task",font="ariel,5,bold",bg="green",fg="white",width=7,command=addtask)
...
btn2=Button(root,text="Completed",bd=0,bg="red",fg="white",command=completed)
